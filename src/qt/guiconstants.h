...
#define QAPP_ORG_NAME "Violette"
#define QAPP_ORG_DOMAIN "violette.net"
#define QAPP_APP_NAME_DEFAULT "Violette-Qt"
#define QAPP_APP_NAME_TESTNET "Violette-Qt-testnet"

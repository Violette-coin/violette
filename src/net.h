...
/** violette: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // violette: known sent sync-checkpoint
    ...
    // violette: used to detect branch switches
